...
import ProgressBar from '../../components/telemetry/ProgressBar';
...
export default function TelemetryPage() {
    ...
    const getTempStatus = (temp, warn, crit) => {
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-slate-100 font-sans overflow-x-hidden rounded-xl">
